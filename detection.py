...
class Detection:
    def __init__(self,root):
        ...
        img_top=Image.open(r"C:\Users\admin\Downloads\WhatsApp Image 2023-12-14 at 01.14.47 (11).jpeg")
        img_top=img_top.resize((550,700),Image.LANCZOS)
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=0,y=50,width=550,height=700)

        img_bottom=Image.open(r"C:\Users\admin\Downloads\WhatsApp Image 2024-01-14 at 22.29.42.jpeg")
        img_bottom=img_bottom.resize((800,700),Image.LANCZOS)
        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)

        f_lbl1=Label(self.root,image=self.photoimg_bottom)
        f_lbl1.place(x=550,y=50,width=800,height=700)

        b1=Button(f_lbl1,text="FACE RECOGNIZER",cursor="hand2",command=self.face_recog,font=("times new roman",13,"bold"), bg="dark blue",fg="white")
        b1.place(x=300,y=580,width=200,height=40)

    def mark_attendance(self,i,r,n,d):
        with open("Shikha.csv","r+",newline="\n") as f:
